                    ...
                    <div class="control">
                        ...
                        <div class="select is-fullwidth">
                            <select name="tipo_usuario" required>
                                <option value="administrador" <?php echo ($datos['tipo_usuario'] == 'administrador') ? 'selected' : ''; ?>>Administrador</option>
                                <option value="usuario" <?php echo ($datos['tipo_usuario'] == 'usuario') ? 'selected' : ''; ?>>Usuario</option>
								<option value="mantenimiento" <?php echo ($datos['tipo_usuario'] == 'mantenimiento') ? 'selected' : ''; ?>>Mantenimiento</option>
                            </select>
                        </div>
                    </div>
                </div>
