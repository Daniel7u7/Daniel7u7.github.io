<?php
    ...
    $actualizar_usuario = $actualizar_usuario->prepare("UPDATE usuario SET usuario_nombre=:nombre,usuario_apellido=:apellido,usuario_usuario=:usuario,usuario_clave=:clave,usuario_email=:email, tipo_usuario=:tipo_usuario WHERE usuario_id=:id");
...
$marcadores = [
    ...
    ":clave" => $clave,
    ":email" => $email,
    ":tipo_usuario" => $tipo_usuario, // Nuevo campo
    ":id" => $id
];
