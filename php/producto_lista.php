			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>CODIGO:</strong> '.$rows['producto_codigo'].', <strong>Descripcion:</strong> '.$rows['producto_precio'].', <strong>STOCK:</strong> '.$rows['producto_stock'].', <strong>CATEGORIA:</strong> '.$rows['categoria_nombre'].', <strong>REGISTRADO POR:</strong> '.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'
			              </p>
			            </div>
